d3.json("client/data.json", function(err, info) {
        ...
        var minRate = d3.min(data, function(d) {return d.rate});

        var minw = d3.min(data, function(d) {return d.adjusted_2015});
        var maxw = d3.max(data, function(d) {return d.adjusted_2015}); 
    ...
    var yAxis = d3.svg.axis()
        ...
        .text("us minimum wage (adj 2015 dollars)[1980-2003]");
    ...
    .text("poverty rate (% us population)[1980-2003]");
